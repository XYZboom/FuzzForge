...
design = {
    ...
    "tree_builder_elements": [
        ...
        {"var_name": "program", "element_name": "Program", "kind": "Other", "parent": None, "interface_kind": "Interface", "fields": [{"name": "classContainer", "type": "ClassContainer", "is_child": True, "nullable": True, "is_mutable": True, "with_transform": True, "with_replace": False, "list_base_type": None}, {"name": "funcContainer", "type": "FuncContainer", "is_child": True, "nullable": True, "is_mutable": True, "with_transform": True, "with_replace": False, "list_base_type": None}]},
